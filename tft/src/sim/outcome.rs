...
impl<Move: IsMove, Util: IsUtility, const N: usize> Outcome<Move, Util, N> {
    ...
    /// Construct a new outcome from the outcome of a sequential game, if possible.
    ///
...
impl<'g, Move: IsMove, Util: IsUtility, const N: usize> OutcomeIter<'g, Move, Util, N> {
