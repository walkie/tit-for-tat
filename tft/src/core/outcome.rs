...
impl<'game, Move, MoveIter, Util, const N: usize> OutcomeIter<'game, Move, MoveIter, Util, N>
where
...
impl<'game, Move, MoveIter, Util, const N: usize> Iterator
    for OutcomeIter<'game, Move, MoveIter, Util, N>
where
    Move: Copy + Debug + Eq + Hash,
    MoveIter: Clone + Iterator<Item = Move>,
    Util: Copy + Debug + Num + Ord,
{
